...
DEFAULT_GPKG_PATH = ROOT / "hello_gracethd.gpkg"
DEFAULT_GDB_ZIP_PATH = ROOT / "GDB_TeloiseV3 (1).zip"
DEFAULT_ROUTES_XLSX_PATH = ROOT / "routes_optiques_pur_gdb_TELOISE (2).xlsx"
...
class BuildConfig:
    ...
    routes_xlsx_path: Path = DEFAULT_ROUTES_XLSX_PATH
...
def apply_runtime_config(cfg: BuildConfig) -> None:
    ...
    legacy.GPKG_PATH = cfg.gpkg_path
    legacy.GDB_ZIP_PATH = cfg.gdb_zip_path
    legacy.ROUTES_XLSX_PATH = cfg.routes_xlsx_path
